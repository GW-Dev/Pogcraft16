...
const COLORS = [
    ...
    COLORS.forEach(color => {
        ...
        crushing(
            kj(`${color}_log`),
            200,
            [ { count: 1, item: ps(`${color}_log`) } ],
            [
                { count: 2, id: ps(`${color}_pigment`) },
                { count: 1, id: ps(`${color}_pigment`), chance: 0.5 }
            ]
        );
        ...
        crushing(
            kj(`${color}_leaves`),
            200,
            [ { count: 1, item: ps(`${color}_leaves`) } ],
            [
                { count: 2, id: ps(`${color}_pigment`) },
                { count: 1, id: ps(`${color}_sapling`), chance: 0.1 }
            ]
        );
    });
